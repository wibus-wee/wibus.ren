 ...
 * @LastEditors: Wibus
 * @LastEditTime: 2022-10-07 20:34:50
 * Coding With IU
 */
...
import style from './plum.module.css';
...
const Plum = () => {
  ...
  return (
    <div
      className={clsx("pointer-events-none fixed top-0 bottom-0 left-0 right-0 z-[-1]", style.mask)}
    >
